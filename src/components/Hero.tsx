        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 pt-24 pb-16">
          ...
          <div className="flex-1 text-center lg:text-left lg:animate-slide-up space-y-8">
            <h1 className="text-5xl md:text-7xl lg:text-[80px] xl:text-[100px] font-inter font-bold leading-tight text-foreground">
              Indie Game{' '}
              <span className="text-[#dfa620]">Studio</span>
            </h1>
            ...
            <div className="flex justify-center lg:justify-start pt-4">
              <Button className="btn-gaming text-lg px-10 py-7 lg:hover:scale-105 lg:transition-transform lg:duration-300" size="lg" onClick={() => scrollToSection('games')}>
                Explore Our Games
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-4">
              {navButtons.map(btn => <Button key={btn.target} variant="outline" size="sm" className="gap-2 border-border/50 hover:border-primary/50 hover:bg-primary/10" onClick={() => scrollToSection(btn.target)}>
          ...
          <div className="flex-1 flex justify-center lg:justify-end lg:animate-float">
            <img src={heroCharacter} alt="Game character showcase" loading="eager" fetchPriority="high" className="w-full max-w-[180px] md:max-w-[200px] lg:max-w-[330px] h-auto object-contain drop-shadow-2xl" />
          </div>
        </div>
      </div>
    </section>;
