      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        ...
        <div className="flex justify-center mb-6">
          <nav className="flex space-x-8">
            {navLinks.map((link, index) => <a key={index} href={link.href} className="text-muted-foreground hover:text-primary transition-colors duration-300 font-medium" onClick={e => {
            e.preventDefault();
        ...
        <div className="flex justify-center space-x-6 mb-6">
          ...
          return <a key={index} href={social.href} target="_blank" rel="noopener noreferrer" aria-label={social.label} className="text-muted-foreground hover:text-primary transition-colors duration-300 p-2 rounded-lg hover:bg-primary/10">
