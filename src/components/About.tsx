      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-inter font-bold mb-6">
            ...
            <span className="text-gradient-orange">DeepCut Originals</span>
          </h2>
        ...
        <div className="mb-20 flex justify-center">
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-12">
            ...
            <div className="flex items-center gap-4 bg-card border border-border rounded-2xl px-8 py-6 shadow-lg card-interactive group">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center shadow-lg shadow-primary/30 group-hover:scale-110 transition-transform duration-300">
                <Users className="w-8 h-8 text-primary-foreground" />
              </div>
              <div>
                <div className="text-5xl font-inter font-bold text-gradient-orange animate-count">6</div>
            ...
            <div className="flex items-center gap-4 bg-card border border-border rounded-2xl px-8 py-6 shadow-lg card-interactive group">
              ...
              <div>
                <div className="text-5xl font-inter font-bold text-gradient-orange animate-count">3</div>
        ...
        <div className="border border-border rounded-2xl p-12 max-w-4xl mx-auto text-center shadow-lg bg-card card-interactive">
          ...
          <Button 
            className="btn-gaming btn-glow text-base px-8 py-6" 
