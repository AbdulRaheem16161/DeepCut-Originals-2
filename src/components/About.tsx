      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-20 flex justify-center">
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-12">
            {/* Members */}
            <div className="flex items-center gap-4 bg-card border border-border rounded-2xl px-8 py-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center shadow-lg shadow-primary/20">
