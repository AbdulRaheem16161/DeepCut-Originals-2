    ...
    <section id="about" className="py-20 bg-secondary">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="border border-border rounded-2xl p-12 max-w-4xl mx-auto text-center shadow-lg bg-card card-interactive">
          ...
          <Button 
            className="bg-foreground hover:bg-foreground text-background hover:text-background text-base px-8 py-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg" 
